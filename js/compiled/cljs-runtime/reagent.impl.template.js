...
var G__53274 = o;
goog.object.set(G__53274,reagent.impl.template.cached_prop_name(k),(reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
return (function() { 
var G__53666__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__53666 = function (var_args){
var args = null;
...
while (G__53668__i < G__53668__a.length) {G__53668__a[G__53668__i] = arguments[G__53668__i + 0]; ++G__53668__i;}
  args = new cljs.core.IndexedSeq(G__53668__a,0,null);
} 
return G__53666__delegate.call(this,args);};
G__53666.cljs$lang$maxFixedArity = 0;
G__53666.cljs$lang$applyTo = (function (arglist__53669){
var args = cljs.core.seq(arglist__53669);
return G__53666__delegate(args);
});
...
var G__53290 = o;
goog.object.set(G__53290,reagent.impl.template.cached_custom_prop_name(k),reagent.impl.template.convert_prop_value(v));
...
if(cljs.core.ifn_QMARK_(x)){
return (function() { 
var G__53675__delegate = function (args){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(x,args);
};
var G__53675 = function (var_args){
var args = null;
if (arguments.length > 0) {
var G__53676__i = 0, G__53676__a = new Array(arguments.length -  0);
while (G__53676__i < G__53676__a.length) {G__53676__a[G__53676__i] = arguments[G__53676__i + 0]; ++G__53676__i;}
  args = new cljs.core.IndexedSeq(G__53676__a,0,null);
} 
return G__53675__delegate.call(this,args);};
G__53675.cljs$lang$maxFixedArity = 0;
G__53675.cljs$lang$applyTo = (function (arglist__53677){
var args = cljs.core.seq(arglist__53677);
return G__53675__delegate(args);
});
G__53675.cljs$core$IFn$_invoke$arity$variadic = G__53675__delegate;
return G__53675;
})()
;
} else {
...
var G__53298 = props;
var G__53298__$1 = (((((!((id == null)))) && ((new cljs.core.Keyword(null,"id","id",-1388402092).cljs$core$IFn$_invoke$arity$1(props) == null))))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__53298,new cljs.core.Keyword(null,"id","id",-1388402092),id):G__53298);
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__53298__$1,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$2(class$,new cljs.core.Keyword(null,"class","class",-2030961996).cljs$core$IFn$_invoke$arity$1(props)));
} else {
return G__53298__$1;
}
});
...
var props__$1 = reagent.impl.template.set_id_class((function (){var G__53364 = props;
if(cljs.core.truth_(class$)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__53364,new cljs.core.Keyword(null,"class","class",-2030961996),reagent.impl.util.class_names.cljs$core$IFn$_invoke$arity$1(class$));
} else {
return G__53364;
}
})(),id_class);
...
reagent.impl.template.input_node_set_value = (function reagent$impl$template$input_node_set_value(node,rendered_value,dom_value,component,p__53410){
var map__53413 = p__53410;
var map__53413__$1 = (((((!((map__53413 == null))))?(((((map__53413.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__53413.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__53413):map__53413);
var on_write = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__53413__$1,new cljs.core.Keyword(null,"on-write","on-write",31519475));
...
return (jsprops.onChange = (function (p1__53447_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__53447_SHARP_);
}));
} else {
return null;
}
...
var vec__53531 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53531,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53531,(1),null);
var className = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53531,(2),null);
...
var temp__5739__auto___53699 = reagent.impl.template.key_from_vec(v);
if((temp__5739__auto___53699 == null)){
} else {
var key_53700 = temp__5739__auto___53699;
(jsprops.key = key_53700);
}
...
var temp__5739__auto___53704 = reagent.impl.template.key_from_vec(argv);
if((temp__5739__auto___53704 == null)){
} else {
var key_53705 = temp__5739__auto___53704;
(jsprops.key = key_53705);
}
...
var G__53580 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,component,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__53580) : reagent.impl.template.as_element.call(null,G__53580));
} else {
var temp__5739__auto___53730 = reagent.impl.template.get_key(cljs.core.meta(argv));
if((temp__5739__auto___53730 == null)){
} else {
var key_53731 = temp__5739__auto___53730;
(jsprops.key = key_53731);
}
...
var G__53594 = n;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2("",G__53594)){
return x;
} else {
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(null,G__53594)){
return x;
} else {
...
var len__4736__auto___53740 = arguments.length;
var i__4737__auto___53741 = (0);
while(true){
if((i__4737__auto___53741 < len__4736__auto___53740)){
args__4742__auto__.push((arguments[i__4737__auto___53741]));

var G__53743 = (i__4737__auto___53741 + (1));
i__4737__auto___53741 = G__53743;
continue;
} else {
}
break;
...
/** @this {Function} */
(reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq53598){
var G__53599 = cljs.core.first(seq53598);
var seq53598__$1 = cljs.core.next(seq53598);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__53599,seq53598__$1);
}));
...
break;
default:
var G__53756 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.with_meta(v,null),(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null),cljs.core.meta(v));
v = G__53756;
continue;
...
var ctx = ({});
var vec__53645 = reagent.ratom.check_derefs((function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
}));
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53645,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__53645,(1),null);
...
var G__53657 = (cljs.core.count(argv) - first_child);
switch (G__53657) {
case (0):
