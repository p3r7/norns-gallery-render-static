...
var G__43146 = devtools.prefs.pref(v);
v = G__43146;
continue;
} else {
return v;
...
}catch (e43062){var _e__42079__auto__ = e43062;
return false;
}})();
...
}catch (e43087){var _e__42079__auto__ = e43087;
return false;
}})();
...
}catch (e43094){var _e__42079__auto__ = e43094;
return false;
}}
}
});
...
var vec__43113 = devtools.munging.parse_constructor_info(constructor_fn);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43113,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43113,(1),null);
...
return cljs.core.some((function (p1__43123_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(devtools.formatters.helpers.pref(new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__43123_SHARP_);
}),template);
});
