...
var o42550 = temp__5733__auto__;
var temp__5733__auto____$1 = (o42550["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o42551 = temp__5733__auto____$1;
return (o42551["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__42054__auto__ = f;
return (o__42054__auto__["toString"]).call(o__42054__auto__);
} else {
return "";
}
}catch (e42556){var _ = e42556;
return "";
}});
...
try{var o__42054__auto___43023 = t;
(o__42054__auto___43023["cljs$lang$ctorPrWriter"]).call(o__42054__auto___43023,t,writer);
}catch (e42583){var __43024 = e42583;
}
...
var char_code = (function (){var o__42054__auto__ = (new String(char$));
return (o__42054__auto__["charCodeAt"]).call(o__42054__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__42054__auto__ = String;
return (o__42054__auto__["fromCharCode"]).call(o__42054__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__42621 = num_code;
switch (G__42621) {
case (1):
return (185);
...
var o__42054__auto__ = String;
return (o__42054__auto__["fromCharCode"]).call(o__42054__auto__,superscript_code);
});
/**
...
}catch (e42676){var _e__42079__auto__ = e42676;
return false;
}})())){
...
var vec__42691 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42691,(0),null);
...
(devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__42764){
var vec__42765 = p__42764;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42765,(0),null);
...
var G__43096 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__43097 = cljs.core.butlast(remaining_tokens);
name_tokens = G__43096;
remaining_tokens = G__43097;
continue;
}
}
break;
...
/** @this {Function} */
(devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq42753){
...
var vec__42784 = cljs.core.split_with((function (p1__42781_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__42781_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42784,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42784,(1),null);
...
var vec__42798 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42798,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42798,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__43101 = cljs.core.rest(remaining_tokens);
var G__43102 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__43101;
name_tokens = G__43102;
continue;
} else {
...
var vec__42818 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42818,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42818,(1),null);
var vec__42821 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42821,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42821,(1),null);
var vec__42824 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42824,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42824,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42824,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42824,(3),null);
...
var vec__42848 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42848,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42848,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42848,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42848,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42848,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42848,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__42854 = temp__5733__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42854,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42854,(1),null);
var vec__42857 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42857,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42857,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__42866 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__42866) : devtools.munging.parse_fn_info_deep.call(null,G__42866));
})()));
}
} else {
return fn_info;
...
var G__43129 = (arity + (1));
var G__43130 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__42893){
var vec__42898 = p__42893;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42898,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42898,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__42906_SHARP_){
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__42906_SHARP_);
}),sorted_keys);
var sorted_infos = cljs.core.map.cljs$core$IFn$_invoke$arity$2(devtools.munging.parse_fn_info_deep,sorted_fns);
var sorted_args_lists = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__42907_SHARP_){
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__42907_SHARP_);
}),sorted_infos);
...
var args__4742__auto__ = [];
var len__4736__auto___43139 = arguments.length;
var i__4737__auto___43140 = (0);
while(true){
if((i__4737__auto___43140 < len__4736__auto___43139)){
args__4742__auto__.push((arguments[i__4737__auto___43140]));

var G__43141 = (i__4737__auto___43140 + (1));
i__4737__auto___43140 = G__43141;
continue;
} else {
}
break;
...
(devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__42922){
var vec__42923 = p__42922;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42923,(0),null);
...
/** @this {Function} */
(devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq42914){
var G__42915 = cljs.core.first(seq42914);
var seq42914__$1 = cljs.core.next(seq42914);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__42915,seq42914__$1);
}));
...
var G__42930 = arg;
var G__42930__$1 = (((G__42930 instanceof cljs.core.Keyword))?G__42930.fqn:null);
switch (G__42930__$1) {
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42961__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42961__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42961__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42961__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__42962 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42962,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42962,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42962,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42962,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42962,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42962,(5),null);
...
var o__42054__auto__ = f;
return (o__42054__auto__["getBasis"]).call(o__42054__auto__);
});
/**
...
}catch (e42970){var _e__42079__auto__ = e42970;
...
var G__43168 = (obj[cljs.core.first(path)]);
var G__43169 = cljs.core.rest(path);
obj = G__43168;
path = G__43169;
continue;
} else {
...
var _STAR_ = (function (accum,p__42992){
var vec__42993 = p__42992;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42993,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__42993,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__43003){
var vec__43005 = p__43003;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43005,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43005,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43005,(2),null);
...
var post_process = (function (p__43011){
var vec__43012 = p__43011;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43012,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__43012,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__43009_SHARP_){
return (obj[cljs.core.first(p1__43009_SHARP_)]);
}),sorted_matches);
