...
var cljs$tools$reader$reader_types$Reader$read_char$dyn_43304 = (function (reader){
...
return cljs$tools$reader$reader_types$Reader$read_char$dyn_43304(reader);
}
});

var cljs$tools$reader$reader_types$Reader$peek_char$dyn_43307 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$Reader$peek_char$dyn_43307(reader);
}
});
...
var cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_43312 = (function (reader,ch){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IPushbackReader$unread$dyn_43312(reader,ch);
}
});
...
var cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_43333 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_line_number$dyn_43333(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_43337 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_column_number$dyn_43337(reader);
}
});

var cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_43348 = (function (reader){
var x__4428__auto__ = (((reader == null))?null:reader);
...
return cljs$tools$reader$reader_types$IndexingReader$get_file_name$dyn_43348(reader);
}
});
...
var G__43407 = rdr.cljs$tools$reader$reader_types$Reader$read_char$arity$1(null);
var G__43408 = s.append(c);
c = G__43407;
s = G__43408;
continue;
}
