...
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42988__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42988__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__42988__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e42983){var _e = e42983;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___43034 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___43034)){
var seen_errors_43035 = temp__5733__auto___43034;
if(cljs.core.truth_(seen_errors_43035.has(self))){
} else {
seen_errors_43035.add(self);

var temp__5735__auto___43036 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___43036)){
var sense_43038 = temp__5735__auto___43036;
(self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_43038)].join(''));
} else {
}
}
} else {
