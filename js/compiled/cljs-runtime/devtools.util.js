...
var len__4736__auto___46646 = arguments.length;
var i__4737__auto___46647 = (0);
while(true){
if((i__4737__auto___46647 < len__4736__auto___46646)){
args__4742__auto__.push((arguments[i__4737__auto___46647]));

var G__46650 = (i__4737__auto___46647 + (1));
i__4737__auto___46647 = G__46650;
continue;
} else {
}
break;
...
var _STAR_print_newline_STAR__orig_val__46409_46652 = cljs.core._STAR_print_newline_STAR_;
var _STAR_print_fn_STAR__orig_val__46410_46653 = cljs.core._STAR_print_fn_STAR_;
var _STAR_print_newline_STAR__temp_val__46411_46654 = true;
var _STAR_print_fn_STAR__temp_val__46412_46655 = (function (x__4668__auto__){
return sb__4667__auto__.append(x__4668__auto__);
});
(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__temp_val__46411_46654);

(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__temp_val__46412_46655);

try{var _STAR_print_level_STAR__orig_val__46416_46658 = cljs.core._STAR_print_level_STAR_;
var _STAR_print_level_STAR__temp_val__46417_46659 = (300);
(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__temp_val__46417_46659);

try{cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.pprint.pprint,args);
}finally {(cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR__orig_val__46416_46658);
}}finally {(cljs.core._STAR_print_fn_STAR_ = _STAR_print_fn_STAR__orig_val__46410_46653);

(cljs.core._STAR_print_newline_STAR_ = _STAR_print_newline_STAR__orig_val__46409_46652);
}
...
/** @this {Function} */
(devtools.util.pprint_str.cljs$lang$applyTo = (function (seq46404){
var self__4724__auto__ = this;
return self__4724__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq46404));
}));
...
var new_formatters = current_formatters.filter((function (p1__46457_SHARP_){
return (!(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(detector,p1__46457_SHARP_)));
}));
...
var G__46472_46746 = f;
var target__42073__auto___46747 = G__46472_46746;
if(cljs.core.truth_(target__42073__auto___46747)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__46472_46746)].join(''),"\n","target__42073__auto__"].join('')));
}

(target__42073__auto___46747["toString"] = (function (){
...
var G__46481_46756 = "%c%s";
var G__46482_46757 = "color:transparent";
var G__46483_46758 = devtools.util.make_detection_printer();
(f.cljs$core$IFn$_invoke$arity$3 ? f.cljs$core$IFn$_invoke$arity$3(G__46481_46756,G__46482_46757,G__46483_46758) : f.call(null,G__46481_46756,G__46482_46757,G__46483_46758));
...
var args__4742__auto__ = [];
var len__4736__auto___46769 = arguments.length;
var i__4737__auto___46770 = (0);
while(true){
if((i__4737__auto___46770 < len__4736__auto___46769)){
args__4742__auto__.push((arguments[i__4737__auto___46770]));

var G__46772 = (i__4737__auto___46770 + (1));
i__4737__auto___46770 = G__46772;
continue;
} else {
}
break;
...
var vec__46555 = devtools.util.feature_list_display(installed_features,feature_groups);
var fmt_str = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46555,(0),null);
var fmt_params = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__46555,(1),null);
return devtools.util.wrap_with_custom_formatter_detection_BANG_((function() { 
var G__46774__delegate = function (add_fmt,add_args){
...
var G__46774 = function (add_fmt,var_args){
var add_args = null;
if (arguments.length > 1) {
var G__46775__i = 0, G__46775__a = new Array(arguments.length -  1);
while (G__46775__i < G__46775__a.length) {G__46775__a[G__46775__i] = arguments[G__46775__i + 1]; ++G__46775__i;}
  add_args = new cljs.core.IndexedSeq(G__46775__a,0,null);
} 
return G__46774__delegate.call(this,add_fmt,add_args);};
G__46774.cljs$lang$maxFixedArity = 1;
G__46774.cljs$lang$applyTo = (function (arglist__46776){
var add_fmt = cljs.core.first(arglist__46776);
var add_args = cljs.core.rest(arglist__46776);
return G__46774__delegate(add_fmt,add_args);
});
...
/** @this {Function} */
(devtools.util.display_banner_BANG_.cljs$lang$applyTo = (function (seq46530){
var G__46531 = cljs.core.first(seq46530);
var seq46530__$1 = cljs.core.next(seq46530);
var G__46532 = cljs.core.first(seq46530__$1);
var seq46530__$2 = cljs.core.next(seq46530__$1);
var G__46533 = cljs.core.first(seq46530__$2);
var seq46530__$3 = cljs.core.next(seq46530__$2);
var self__4723__auto__ = this;
return self__4723__auto__.cljs$core$IFn$_invoke$arity$variadic(G__46531,G__46532,G__46533,seq46530__$3);
}));
...
var seq__46586 = cljs.core.seq(features);
var chunk__46587 = null;
var count__46588 = (0);
var i__46589 = (0);
while(true){
if((i__46589 < count__46588)){
var feature = chunk__46587.cljs$core$IIndexed$_nth$arity$2(null,i__46589);
...
var G__46785 = seq__46586;
var G__46786 = chunk__46587;
var G__46787 = count__46588;
var G__46788 = (i__46589 + (1));
seq__46586 = G__46785;
chunk__46587 = G__46786;
count__46588 = G__46787;
i__46589 = G__46788;
continue;
} else {
var temp__5735__auto__ = cljs.core.seq(seq__46586);
if(temp__5735__auto__){
var seq__46586__$1 = temp__5735__auto__;
if(cljs.core.chunked_seq_QMARK_(seq__46586__$1)){
var c__4556__auto__ = cljs.core.chunk_first(seq__46586__$1);
var G__46789 = cljs.core.chunk_rest(seq__46586__$1);
var G__46790 = c__4556__auto__;
var G__46791 = cljs.core.count(c__4556__auto__);
var G__46792 = (0);
seq__46586 = G__46789;
chunk__46587 = G__46790;
count__46588 = G__46791;
i__46589 = G__46792;
continue;
} else {
var feature = cljs.core.first(seq__46586__$1);
if(cljs.core.not(cljs.core.some(cljs.core.PersistentHashSet.createAsIfByAssoc([feature]),known_features))){
devtools.context.get_console.call(null).warn(devtools.util.unknown_feature_msg.call(null,feature,known_features,lib_info));
} else {
}
...
var G__46796 = cljs.core.next(seq__46586__$1);
var G__46797 = null;
var G__46798 = (0);
var G__46799 = (0);
seq__46586 = G__46796;
chunk__46587 = G__46797;
count__46588 = G__46798;
i__46589 = G__46799;
continue;
}
} else {
...
if(cljs.core.truth_(temp__5733__auto__)){
var o46628 = temp__5733__auto__;
return (o46628["version"]);
} else {
return null;
}
})() == null);
